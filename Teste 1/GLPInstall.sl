...
mysql_trinfo_to_sql /usr/share/zoneinfo | sudo mysql -u root mysql
...
<VirtualHost *:80>
	  ...
	  <Directory /var/www/glpi/public>
		    Require all granted
		    RewriteEngine On
		    RewriteCond %{REQUEST_FILMNAME} !-f
...
#download do glpi
uget -q https://github.com/glpi-project/glpi/releases/download/10.0.7/glpi-10.0.7.tgz
tar -zxf glpi-*
